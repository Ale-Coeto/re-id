...
model_p = "/home/alanromero/ale/re-id/Crowd-Counting/testsOscar/models/osnet_x1_0_duke_256x128_amsgrad_ep150_stp60_lr0.0015_b64_fb10_softmax_labelsmooth_flip.pth"
...
def extract_features_torchreid(cropped_image, custom_extractor=extractor):
    img_crop = val_transforms(cropped_image.convert('RGB')).unsqueeze(0)
    feature = custom_extractor(img_crop).cpu().detach().numpy()[0]
    return feature
